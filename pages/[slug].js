...
function Astro({postData}) {
    ...
    return (
        ...
        <div className={shrinkAnimation?'astro darkpage':'astro'}>
            <div className='imgbackground big' style={{right:shrinkAnimation?'340px':'0px', transform:shrinkAnimation?`scale(${shrinkSize})`:'', transition: shrinkAnimation?'all 0.8s linear':'', bottom:shrinkAnimation?'10px':'0px'}}>
