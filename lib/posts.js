const posts = [
    ...
    {
        title: 'Super Aglomerado de Virgem',
        image: '/virgo.png',
        conceptualImage: true,
        radius: 110000000,
        description: 'O superaglomerado de Virgem, chamado também de superaglomerado local, é um superaglomerado de galáxias. Nele está contido o Grupo Local de Galáxias com nossa galáxia, a Via Láctea. Possui a forma de um disco plano, com um diâmetro de 200 milhões de anos-luz.',
        slug: 'aglomerado_de_virgem'
    },
    {
        title: 'Laniakea',
        image: '/laniakea.png',
...
export function getPost(slug){
    ...
    allPosts.map((p, index) => {
        if(p.slug === slug){
            ...
            let nextPost = {title: 'Universo Observável', radius: 46500000000, image:'/universe.png', slug: 'universo_observavel'}
