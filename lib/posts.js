...
export function getPost(slug){
    ...
    allPosts.map((p, index) => {
        if(p.slug === slug){
            let previousPost = {title:'Lua', radius:1.737, image: '/moon.png', slug:''}
            let nextPost = {title: 'Andrômeda', radius: 1040680351983804.800, image:'/andromeda.png', slug: 'andromeda'}
